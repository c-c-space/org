...
function lunarPhase(l, query) {
    if (l >= 0 && l <= 1.0) {
        ...
        earth = '月は太陽と同じ方向から太陽を向いた地球の左方向へ、日の入り後の西の空に半月へ満ちてゆく月が見える';
    } else if (l >= 6.6 && l <= 8.2) {
        emoji = '🌓';
        phase = '上弦 First Quarter';
        earth = '月は太陽を向いた地球の左方向にあり、昼ごろから真夜中に東から昇り西へ沈む半月が見える';
    } else if (l >= 8.3 && l <= 13.7) {
        emoji = '🌔';
        phase = 'Waxing Gibbous';
        earth = '月は太陽を向いた地球の左方向から太陽の反対方向へ、日の入り前から真夜中すぎに満月へと満ちていく月が見える';
        ...
        earth = '月は太陽の反対方向から太陽を向いた地球の右方向へ、遅い夜から日の入りすぎに満月から欠けていく月が見える';
    } else if (l >= 21.4 && l <= 22.8) {
        emoji = '🌗';
        phase = '下弦 Last Quarter';
        earth = '月は太陽を向いた地球の右方向にあり、真夜中から昼ごろに東から昇り西へ沈む半月が見える';
    } else {
        emoji = '🌘';
        phase = 'Morning Crescent';
        earth = '月は太陽を向いた地球の右方向から太陽と同じ方向へ、日の出前の東の空に新月へ欠けてゆく月が見える';
    }
